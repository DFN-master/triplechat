    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: mode === "light" ? "#01579B" : "#FFFFFF" },
                textPrimary: mode === "light" ? "#01579B" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#01579B" : "#FFFFFF",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #01579B, #01579B , #01579B)" : "#666",
